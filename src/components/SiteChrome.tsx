  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line/80 bg-white/85 backdrop-blur-md">
      <div className="mx-auto flex h-16 w-full max-w-5xl items-center justify-between gap-4 px-4 sm:px-6">
        <Link
          href="/"
          className="flex items-center gap-2.5 font-display text-sm font-bold tracking-tight text-ink sm:text-base"
        >
          <span className="grid h-8 w-8 place-items-center rounded-lg bg-brand-red text-xs font-black text-white">
            SH
          </span>
